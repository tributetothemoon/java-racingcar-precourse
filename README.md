...
State 2: 게임 중
- [x] 사용자가 입력한 시도 회수만큼 자동차를 랜덤하게 움직인다.
    - [x] 각 자동차마다 난수를 생성해 4이상이면 전진, 이하면 움직이지 않는다.
- [x] 각 회수마다 자동차 이름과 위치를 출력한다.
- [x] 모든 회수가 끝난 후 승자를 출력한다.
...
- [x] CarsDTO : 차들의 이름과 그들의 위치만을 데이터로 담는 DTO객체
